...
;(def obstacle-stroke-value-scratch 
;     (+ obstacle-stroke-value-scratch-in obstacle-stroke-value-scratch-out))
;(def obstacle-stroke-value-bogey 
;     (+ obstacle-stroke-value-bogey-in obstacle-stroke-value-bogey-out))
...
(defn one-score-handicap-differential [score rating slope]
